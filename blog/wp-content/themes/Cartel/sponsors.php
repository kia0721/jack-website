<div class="squarebanner clearfix">
	<h3 class="sidetitl"> Partner Schools </h3>
	<ul>
<li>		
<?php 
	$ban1 = ft_of_get_option('fabthemes_banner2'); 
	$url1 = ft_of_get_option('fabthemes_url2'); 
	$lab1 = ft_of_get_option('fabthemes_lab2'); 	
	$alt1 = ft_of_get_option('fabthemes_alt2');
?>
