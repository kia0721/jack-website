...
@section('css_link_2')
    ...
    #termConditionLink:hover, #forgotStudentLink:hover{
        color: blue;
    }
    

    div.jackStudentContainer{
        margin-top: 80px;
        text-align: center;
    }
    ...
    #personalDetails input[type=radio]{
        margin-right: 5px;
    }
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-12"  style="text-align: center;">
                <h1 style="font-size: 50px;" class="color-1">REGISTRATION</h1>
            </div>
            
        </div>
        <div class="row jackStudentContainer justify-content-md-center">
            <div class="col-md-12" >
                <h5>To start your registration, kindly choose whether the student is new or returning to JACK:</h5>
            </div>
            <div class="col-md-5 jackStudent" id="newStudentBtn">
                <img src="{{ asset('images/new_student_icon.png') }}" /><br><br>
                New Student
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-5 jackStudent"  id="oldStudentBtn" >
                <img src="{{ asset('images/old_student_icon.png') }}" /><br><br>
                Old Student
            </div>
        ...
        <div class="py-2 btn-secondary w-100 my-4"></div>
            <div id="personalDetails">
                ...
                <div class="col-md-12 py-4 register-div">
                    <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                <label class="form-control-label" for="studLastName">Student's last name<span class="form-asterisk">*</span></label>
            ...
            <div id="oldStudentContainer">
                ...
                <div class="col-md-12 py-4 register-div ">
                    <div class="form-group">
                        <label class="form-control-label" for="studentId">Please provide student ID. <span class="form-asterisk">*</span></label>
