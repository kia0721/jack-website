                                        ...
                                        <table style="width: 100%; margin: 30px auto; padding: 0; text-align: center;" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="text-align: left;">
                                                        Hello <b> {{ $result[0]->parentName }} </b> !
                                                            <br><br>
                                                            Good day!<br>

                                                            Here are the details you previously registered.
                                                      
                                                            <br><br>
                                                            @foreach ($result as $stud)
                                                                <p>
                                                                <b>Student ID: </b> {{ $stud->student_id }}<br>
                                                                <b>Student Name: </b> {{ $stud->firstname }} {{ $stud->lastname }} <br>
                                                                <b>Date Registered: </b> {{ $stud->dateRegistered }}                   
